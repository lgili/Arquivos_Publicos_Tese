 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Wed Nov 24 17:32:20 2021
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME FPGA
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
/* %%%-SFUNWIZ_defines_Changes_BEGIN --- EDIT HERE TO _END */
#define NUM_INPUTS            7
/* Input Port  0 */
#define IN_PORT_0_NAME        svm
#define INPUT_0_WIDTH         18
...
/* Input Port  4 */
#define IN_PORT_4_NAME        cap_errors_v
#define INPUT_4_WIDTH         9
...
extern void FPGA_Outputs_wrapper(const real_T *svm,
			const real_T *idx1,
			const real_T *idx2,
			const real_T *period,
...
{
    const real_T *svm = (real_T *) ssGetInputPortRealSignal(S, 0);
    const real_T *idx1 = (real_T *) ssGetInputPortRealSignal(S, 1);
    const real_T *idx2 = (real_T *) ssGetInputPortRealSignal(S, 2);
    const real_T *period = (real_T *) ssGetInputPortRealSignal(S, 3);
    const real_T *cap_errors_v = (real_T *) ssGetInputPortRealSignal(S, 4);
    const real_T *in1 = (real_T *) ssGetInputPortRealSignal(S, 5);
    const real_T *in2 = (real_T *) ssGetInputPortRealSignal(S, 6);
    real_T *pwm = (real_T *) ssGetOutputPortRealSignal(S, 0);
    real_T *aux = (real_T *) ssGetOutputPortRealSignal(S, 1);

    FPGA_Outputs_wrapper(svm, idx1, idx2, period, cap_errors_v, in1, in2, pwm, aux, S);
